...
#problem.add_equation(eq_eval("ddt(T) - lap(T)/Pe + LiftTau(tau_inner, -1) + LiftTau(tau_outer, -2) = - dot(u,grad(T))"))
#problem.add_equation(eq_eval("ddt(TC) - lap(TC)/Pe + LiftTau(tauC_inner, -1) + LiftTau(tauC_outer, -2) = 0"))
